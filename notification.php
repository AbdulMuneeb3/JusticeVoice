...
<script src="assets/js/jquery-3.5.1.min.js"></script>
    ...
    <div class="wrapper-left">
        <div class="sidebar-left">
          ...
          <div class="grid-sidebar">
            <div class="icon-sidebar-align">
            <img src="<?php echo BASE_URL . "/includes/icons/tweetlogout.png"; ?>" alt="" height="26.25px" width="26.25px" />
      ...
      <div class="grid-posts">
          ...
          <div class="box-home feed">
               <div class="container">
                 <div style="border-bottom: 1px solid #F5F8FA;"  class="row position-fixed box-name">
                       <div class="col-xs-2">
                       <a href="javascript: history.go(-1);"> <img width="25" height="25" src="https://img.icons8.com/ios-filled/50/long-arrow-left.png" alt="long-arrow-left"  style="margin-top:15px"/> </a>
                       </div>
                       <div class="col-xs-10">
                           <p style="margin: 12px 12px;" class="home-name"> Notifications</p>
                      </div>
                 </div>
             ...
             <?php 
                if ($notify->type == 'like') { 
                    $icon = "<img src='" . BASE_URL . "/includes/icons/like.png' alt='Like' height='25px' width='25px' />";
                    $msg = "Liked Your Tweet";
                } else if ($notify->type == 'retweet') { 
                    $icon = "<img src='" . BASE_URL . "/includes/icons/retweet.png' alt='Retweet' height='25px' width='25px' />";
                    $msg = "Retweeted Your Tweet";
                } else if ($notify->type == 'qoute') { 
                    $icon = "<img src='" . BASE_URL . "/includes/icons/quote.png' alt='Quote' height='25px' width='25px' />";
                    $msg = "Quoted Your Tweet";
                } else if ($notify->type == 'comment') { 
                    $icon = "<img src='" . BASE_URL . "/includes/icons/comment.png' alt='Comment' height='25px' width='25px' />";
                    $msg = "Commented on your Tweet";
                } else if ($notify->type == 'reply') { 
                    $icon = "<img src='" . BASE_URL . "/includes/icons/reply.png' alt='Reply' height='25px' width='25px' />";
                    $msg = "Replied to your Comment";
                } else if ($notify->type == 'follow') { 
                    $icon = '<img width="25" height="25" src="https://img.icons8.com/windows/32/add-user-male.png" alt="add-user-male" style="margin-top:6px" />';
                    $msg = "Followed You";
                } else if ($notify->type == 'mention') { 
                    $icon = '<img width="25" height="25" src="https://img.icons8.com/external-neu-royyan-wijaya/32/external-mention-neu-text-neu-royyan-wijaya.png" alt="external-mention-neu-text-neu-royyan-wijaya" style="margin-top:6px" />';
        ...
        <div class="wrapper-right">
            ...
            <img  width="30" height="30" src="https://img.icons8.com/material-outlined/50/search-more.png" alt="search-more"  style="margin-top:6px"/>
            <!-- <i id="icon-search" class="fas fa-search tryy"></i> -->
            <input type="text" class="form-control search-input"  placeholder="Search JusticeVoice">
