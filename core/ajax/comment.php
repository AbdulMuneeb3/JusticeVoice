<?php 
	...
	if(isset($_POST['qoute']) && !empty($_POST['qoute'])){
        ...
        //  if(!$flag_retweeted) {
			...
			// 		   <span class="username-JusticeVoice">@ '.$tweet_user->username.'  </span>
			// 		   <span class="username-JusticeVoice"> $timeAgo </span>
			// 		 </p>
			// 		 <p>
...
<div class="wrap5">
	<div class="retweet-popup-body-wrap">
		<div class="retweet-popup-heading">
			<h3>Reply Tweet</h3>
			<span><button class="close-retweet-popup"><li ><img src="<?php echo BASE_URL . "/includes/icons/close.png"; ?>" alt="" height="19.25px" width="19.25px" aria-hidden="true" /></button></span>
		</div>
...
<?php } ?>
		...
		<div class="retweet-popup-footer"> 
			<div class="retweet-popup-footer-right">
			 ...
			 type="submit"><img width="16" height="16"  src="https://img.icons8.com/small/16/pencil.png" alt="pencil" aria-hidden="true"/>Reply</button>
			</div>
		</div> 
