  		...
  		margin-left: 10px; 
                    ...
                    <div class="retweet-div">
							...
							if(($user_retweeted_it && !$retweet_sign) || $flaga) {
							 ...
							 >  
							 <li ><img src="<?php echo BASE_URL . "/includes/icons/retweet.png"; ?>" alt="" height="19.25px" width="19.25px" />
							...
							// else
							 echo $tweet_id; ?>"> 
								<li ><img src="<?php echo BASE_URL . "/includes/icons/quote.png"; ?>" alt="" height="19.25px" width="19.25px" />
								<!-- <li><i class="fas fa-pencil-alt icon"></i>  -->
								 <span class="option-text"> Quote Voice</span></li>
							</a>
                    </div>
...
<div class="wrap5">
	<div class="retweet-popup-body-wrap">
		<div class="retweet-popup-heading">
			<h3>Quote Tweet</h3>
			<span><button class="close-retweet-popup"><img src="http://localhost/JusticeVoice/includes/icons/close.png" alt="" height="19.25px" width="19.25px" aria-hidden="true"></button></span>
		</div>
		<div class="retweet-popup-input">
			<div class="retweet-popup-input-inner">
			<div class="radio-buttons">
   	 <label>
        <input type="radio" name="option" value="For" onchange="document.getElementById('selected-option').innerText = this.value;">
        For
   	 </label>
   	 <label>
        	<input type="radio" name="option" value="Against" onchange="document.getElementById	('selected-option').innerText = this.value;">
       	 Against
   		 </label>
		</div>
...
<?php } ?>
		...
		<div class="retweet-popup-footer"> 
			<div class="retweet-popup-footer-right">
				...
				data-qoq="<?php echo $qoq; ?>" 
			 type="submit"><img width="16" height="16" src="https://img.icons8.com/small/16/pencil.png" alt="pencil" aria-hidden="true">Quote</button>
			</div>
		</div> 
