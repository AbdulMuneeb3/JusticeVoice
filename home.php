...
<body>
  ...
  <script src="assets/js/jquery-3.5.1.min.js"></script>
    ...
    <?php  if (isset($_SESSION['welcome'])) { ?>
      ...
      <!-- Modal -->
<div class="modal fade" id="welcome" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true"  style="border-radius:1rem;">
  <div  class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content" style="border-radius:1rem; ">
      <div class="">
        <div class="text-center">
         <span  class="modal-title font-weight-bold text-center" id="exampleModalLongTitle">
          <span style="font-size: 20px;"><br>Welcome <span style="color:#207ce5"><?php echo $user->name; ?></span>  </span>  
         </span>
        </div>
      ...
      <div class="modal-body">
        ...
        <p>"Welcome to <span style="font-weight: 700;">JusticeVoice!</span> We're glad you're here. Share your Thoughts, Explore Ideas, and Connect with others who Care. Let your <span style="font-weight: 700;">Voice</span> be heard!"<br>
          This <span style="font-weight: 700;">JusticeVoice</span> Website is Developed by <span style="font-weight: 700;">A2Z Developer.</span>  </p>
                    ...
                    <div class="text">
                      <form class="" action="handle/handleTweet.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="position-relative upload-photo"> 
                          ...
                          <img src="http://localhost/JusticeVoice/includes/icons/close.png" alt="" height="19.25px" width="19.25px" aria-hidden="true" class="position-absolute upload-delete">
                          </div>
                        </div>
                        ...
                        <div class="bottom"> 
                          ...
                          <div class="bottom-container">
                            ...
                            <label for="tweet_img" class="ml-4 mb-2 uni">
                            <img src="<?php echo BASE_URL . "/includes/icons/upload.png"; ?>" alt="" height="26.25px" width="26.25px" />
                            </label>
