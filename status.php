        ...
        <div class="border-right">
          <div class="grid-toolbar-center">
            <div class="center-input-search">
                ...
                <div class="container" style="border-bottom: 1px solid #E9ECEF;">
                 ...
                 <a href="javascript: history.go(-1);"> <img width="25" height="25" src="https://img.icons8.com/ios-filled/50/long-arrow-left.png" alt="long-arrow-left"  style="margin-top:6px"/></a>
                       </div>
                       <div class="col-xs-10 mt-1">
                           <p class="tweet-name" style="
                           font-weight:700; margin-left: 15px;"> Post</p>
          ...
          <?php 
            ...
            ?>
             ...
             <?php if ($tweet_real->statuss !== 'pending') { ?>
          ...
          <div class="box-tweet feed" style="position: relative;" >
            ...
            <?php if ($retweet_sign) { ?>
            <span class="retweed-name"> <li ><img src="<?php echo BASE_URL . "/includes/icons/retweet.png"; ?>" alt="" height="19.25px" width="19.25px" aria-hidden="true"/>
                ...
                <div class="grid-reactions">
                  <div class="grid-box-reaction">
                    ...
                    if($retweet_sign)
                      ...
                      <img src="<?php echo BASE_URL . "/includes/icons/comment.png"; ?>" alt="" height="19.25px" width="19.25px" />
                  ...
                  <div class="grid-box-reaction">
                    ...
                    <img src="<?php echo BASE_URL . "/includes/icons/retweet.png"; ?>" alt="" height="19.25px" width="19.25px" />
                  ...
                  <div  class="grid-box-reaction"  >
                    ...
                    <img src="<?php echo $user_like_it ? BASE_URL . '/includes/icons/like.png' : BASE_URL . '/includes/icons/like.png'; ?>" alt="" height="19.25px" width="19.25px" />
                  ...
                  <div class="grid-box-reaction">
                    ...
                    <img src="<?php echo BASE_URL . "/includes/icons/threedots.png"; ?>" alt="" height="19.25px" width="19.25px" />
