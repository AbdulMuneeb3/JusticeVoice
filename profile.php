...
<head>
    ...
    <title> <?php echo $profileData->name; ?> (@<?php echo $profileData->username; ?>) | JusticeVoice</title>
          ...
          <div class="box-home feed">
               <div class="container">
                 <div   class="row position-fixed box-name">
                       <div class="col-xs-2">
                       <a href="javascript: history.go(-1);"> <img width="25" height="25" src="https://img.icons8.com/ios-filled/50/long-arrow-left.png" alt="long-arrow-left"  style="margin:5px 12px;"/> </a>
                       </div>
                       <div class="col-xs-10">
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="image-upload">
                                ...
                                <img width="30" height="30" src="<?php echo BASE_URL . "/includes/icons/upload.png"; ?>" alt="image--v1" style="position:absolute; top: 225px;
                                 left:385px;"></i> 
                                  </label>
                                  <input id="cover-input" type="file" name="cover"/>
                                  <a href="handle/handleDeleteCover.php" style="top: 225px; left: 430px; color: red; font-size: 18px;" class="position-absolute">
                                  <img width="30" height="30" src="https://img.icons8.com/material-sharp/24/trash.png" alt="trash" /></a>
